...
/**ACCOUNTING MANAGER URL CONSTATNS**/
define('URL_ACCOUNTING_MANAGER', SITEURL.'accounting_manager'.DS.'index');
define('URL_AC_PROFILE',SITEURL.'accounting_manager'.DS.'profile');
define('URL_AC_CHANGE_PASSWORD',SITEURL.'accounting_manager'.DS.'change_password');
define('URL_AC_ORDERS',SITEURL.'accounting_manager'.DS.'orders');
define('URL_AC_AJAX_GET_ORDERS',SITEURL.'accounting_manager'.DS.'ajax_get_orders');
define('URL_AC_VIEW_ORDER',SITEURL.'accounting_manager'.DS.'view_order');
define('URL_AC_UPDATE_ORDER',SITEURL.'accounting_manager'.DS.'update_order');

/**KASIER MANAGER URL CONSTATNS**/
define('URL_KASIER_MANAGER', SITEURL.'kasier_manager'.DS.'index');
define('URL_KR_PROFILE',SITEURL.'kasier_manager'.DS.'profile');
define('URL_KR_CHANGE_PASSWORD',SITEURL.'kasier_manager'.DS.'change_password');
define('URL_KR_ORDERS',SITEURL.'kasier_manager'.DS.'orders');
define('URL_KR_AJAX_GET_ORDERS',SITEURL.'kasier_manager'.DS.'ajax_get_orders');
define('URL_KR_VIEW_ORDER',SITEURL.'kasier_manager'.DS.'view_order');
define('URL_KR_UPDATE_ORDER',SITEURL.'kasier_manager'.DS.'update_order');
...
/***SUPPLIER MODULE URLS**/
define('URL_SUPPLIER_INDEX',SITEURL.'supplier'.DS.'index');
define('URL_SUPPLIER_AJAX_GET_LIST', SITEURL.'supplier'.DS.'ajax_get_list');
define('URL_ADDEDIT_SUPPLIER',SITEURL.'supplier'.DS.'addedit'.DS);

/***PRODUCT MODULE URLS**/
define('URL_STOCK_INDEX',SITEURL.'stock'.DS.'index');
define('URL_STOCK_AJAX_GET_LIST', SITEURL.'stock'.DS.'ajax_get_list');
define('URL_ADDEDIT_STOCK',SITEURL.'stock'.DS.'addedit'.DS);
...
define('CLASS_EDIT_BTN', 'btn btn-primary waves-effect waves-light me-1');
define('CLASS_DELETE_BTN', 'btn btn-danger waves-effect waves-light');
...
define('CLASS_ICON_VIEW', 'bx bx-search-alt');
define('CLASS_ICON_EDIT', 'bx bx-edit-alt');
define('CLASS_ICON_DELETE', 'bx bx-trash');
define('CLASS_ICON_MAKE_DEFAULT', 'bx bxs-hand-right');
define('CLASS_ICON_VIEW_ADD_IMAGE', 'bx bx-image-alt');
define('CLASS_ICON_STAR', 'bx bx-star');
...
define('THUMB_IMG_WIDTH',180);
define('THUMB_IMG_HEIGHT',180);
