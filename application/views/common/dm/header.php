                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <!-- App Search-->
                            <div class="app-search d-none d-lg-block">
                                <a href="<?php echo URL_DM_ORDERS; ?>" type="button" class="btn btn-outline-primary waves-effect">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="<?php echo URL_DM_PROFILE;?>">
                                    <i class="uil uil-user-circle font-size-18 align-middle text-muted me-1"></i> 
                                    <span class="align-middle"><?php echo get_languageword('profile');?></span>
                                </a>

                                <a class="dropdown-item" href="<?php echo URL_DM_CHANGE_PASSWORD;?>">
                                    <i class="uil uil-user-circle font-size-18 align-middle text-muted me-1"></i> 
