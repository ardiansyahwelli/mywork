...
<html lang="<?php echo get_language_code();?>" dir="<?php echo language_type();?>">
    ...
    <head>
        ...
        <!-- App Css-->
        <link href="<?= base_url() ?>public/css/app.min.css" rel="stylesheet" />
    </head>
<body>
                    ...
                    <div class="d-flex">
                        ...
                        <!-- App Search-->
                            <div class="app-search d-none d-lg-block">
                                <a href="#" type="button" class="btn btn-outline-primary waves-effect">
                                <i class="bx bx-bookmarks"></i>Sales</a>

                                <a href="#" type="button" class="btn btn-outline-primary waves-effect">
                                <i class="bx bxs-cart"></i>Purchases</a>

                                <a href="<?php echo URL_ORDERS_INDEX.'new';?>" type="button" class="btn btn-outline-primary waves-effect">
                                <i class="bx bx-calculator"></i>Cashier</a>

                                <a href="<?php echo URL_ORDERS_INDEX.'process';?>" type="button" class="btn btn-outline-primary waves-effect">
                                <i class="bx bx-restaurant"></i>Kitchen</a>
                            </div>
                    </div>
