                    ...
                    <div class="card-body">
                        <div class="card-title-desc">
                            <div class="text-right">
                                <div class="form-group">
                                    <a class="btn btn-primary" href="<?php echo URL_ADDEDIT_ADDON;?>">
                                        <i class="bx bx-plus"></i><?php echo get_languageword('add_record'); ?>
                                    </a>

                                    <a class="btn btn-success" href="<?php echo URL_ADDONS_INDEX;?>">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
	                            <tr>
	                                <th>
	                                <input type="checkbox" class="ip_check_all" name="check_all" id="check_all" onclick="toggle_check_all(this);"> </th>   
                                    </th>
