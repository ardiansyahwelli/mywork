        ...
        if ($this->input->is_ajax_request()) {
            ...
            if (!empty($records)) {
                ...
                foreach ($records as $record) {
                    ...
                    $row[] = '<span><img src="'.$image.'" class="img-responsive center-block" width="50%"/></span>';
                    
                    $checked = '';
                    $class = 'badge bg-soft-danger font-size-14';
                    if ($record->status == 'Active') {
                        $checked = ' checked';
                        $class = 'badge bg-soft-success font-size-14';    
                    }
                    ...
                    $str .= '<a data-bs-toggle="modal" data-bs-target=".bs-example-modal-sm" title="'.get_languageword('delete').'" class="'.CLASS_DELETE_BTN.'" onclick="set_fields(\'delete\', \''.$record->addon_id.'\');"><i class="'.CLASS_ICON_DELETE.'" ></i> </a>';
