        ...
        if ($this->input->is_ajax_request()) {
            ...
            if (!empty($records)) {
                ...
                foreach ($records as $record) {
                    ...
                    $class = 'badge rounded-pill bg-soft-danger font-size-14';
                    if ($record->status == 'new') {
                        $class = 'badge rounded-pill bg-soft-success font-size-14';    
                    } else if ($record->status == 'delivered') {
                        $class = 'badge rounded-pill bg-soft-info font-size-14';    
                    } else if ($record->status == 'process') {
                        $class = 'badge rounded-pill bg-soft-success font-size-14';    
                    } else if ($record->status == 'out_to_deliver') {
                        $class = 'badge rounded-pill bg-soft-warning font-size-14';    
                    }
