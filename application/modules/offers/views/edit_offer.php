                                    ...
                                    <div data-repeater-item class="row">
                                       ...
                                       <div class="col-lg-2 align-self-center">
                                            <div class="btn-group">
                                            	...
                                            	<input type="button" name="add" class="btn btn-primary" onclick="AddRow();" id="btn" value="+ Add">

                                               <input type="button" name="reset" class="btn btn-warning" onclick="removeRow();" value="- Delete">
