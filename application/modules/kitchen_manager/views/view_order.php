                            ...
                            <div class="py-2">
                                ...
                                <div class="d-print-none mt-4">
                                    <div class="float-end">
                                        ...
                                        <?php if(isset($order) && ($order->status=='process')) {?>
											   <!-- Small modal -->
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mySmallModalLabel"><?php echo get_languageword('orders');?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <?php echo form_open(URL_KM_UPDATE_ORDER,array('id'=>'order_status_form'));?>
                <div class="modal-body">
                    <div class="form-group">
					  <label><?php echo get_languageword('update_order_status').required_symbol();?></label>
						<?php $status = array(''=>get_languageword('select'),'out_to_deliver'=>get_languageword('out_to_deliver'));
						$val='';
						echo form_dropdown('order_status',$status,$val,'class="form-select" onchange="get_dm_div(this.value)" required');			
						?>
					  </div>
					 
					  
					  <div class="form-group">
					  <label><?php echo get_languageword('delivery_manager').required_symbol();?></label>
					  <?php 
					  $val='';
						echo form_dropdown('dm_id',$delivery_managers,$val,'class="form-select" id="dm_id" required');
					  ?>
					  </div>
