	            ...
	            <div class="row">
	                <div class="col-md-3">
	                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
	                        ...
	                        <a class="nav-link mb-2 active" href="<?php echo URL_ADMIN_CHANGE_PASSWORD;?>">Change Password</a>
	                ...
	                <div class="col-md-9">
	                    <div class="tab-content text-muted mt-4 mt-md-0"s id="v-pills-tabContent">
	                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
	                            ...
	                            <?php $attributes = array('name'=>'profile_form','id'=>'profile_form'); echo form_open_multipart(URL_ADMIN_PROFILE,$attributes);?>
