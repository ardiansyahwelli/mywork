        ...
        if ($this->input->is_ajax_request()) {
            ...
            if (!empty($records)) {
                ...
                foreach ($records as $record) {
                    ...
                    $str .= '<a data-bs-toggle="modal" data-bs-target=".bs-example-modal-sm" title="'.get_languageword('delete').'" class="'.CLASS_DELETE_BTN.'" onclick="set_fields(\'delete\', \''.$record->option_id.'\');"><i class="'.CLASS_ICON_DELETE.'" ></i> </a>';
